export const webflowProjects = [
  ...
  },
  {
    ...
    domain: 'odoscope.com',
    desc: 'Main marketing site for Odoscope, a personalisation and analytics platform. Bold, structured layout showcasing AI-driven commerce personalisation features and integrations.',
  ...
  },
  {
    ...
    desc: 'Fitness and wellness platform website with energetic visual language, membership flows, and class/trainer discovery. Designed for mobile-first fitness audiences.',
  ...
  },
  {
    ...
    desc: 'The #1 NIL & Life After Sports Hub — 600,000+ athlete and alumni profiles. Features NIL marketplace, job board, scholarships, coach connections, and multi-user type onboarding.',
  ...
  },
  {
    ...
    desc: 'Wellness and mindfulness brand site with a calm, refined visual aesthetic. Focused on communicating brand philosophy, retreat offerings, and community through serene design.',
  ...
  },
  {
    ...
    desc: 'Industrial CT scanning, 3D inspection, and reverse engineering services for manufacturing. Website highlights their ISO-accredited process, case studies, and industry expertise.',
  ...
  },
  {
    ...
    domain: 'dualo.io',
    desc: 'AI-powered research assistant for UX, CX, and marketing teams. Automates literature reviews, summarizes documents, and securely organizes customer insights.',
  ...
  },
  {
    ...
    desc: 'Full-service development agency specializing in MVPs and agile product development for web and mobile apps. Features case studies for real estate and grant management portals.',
  ...
  },
  {
    ...
    desc: 'E-commerce brand selling melatonin-free sleep aids, mouth tape, and nasal strips. Focuses on education around nasal breathing and natural sleep solutions.',
  ...
  },
  {
    ...
    desc: 'Smart home and commercial integration services. Offers bespoke solutions for lighting control, audio/video, home theaters, security, and professional calibration.',
...
export const wordpressProjects = [
  {
    num: 'WP·01',
    title: 'Yard Athletics',
    url: 'https://yardathletics.ca',
    domain: 'yardathletics.ca',
    desc: 'Boutique strength & conditioning gym in Canada. Full WordPress site covering 8 service types, MindBody booking integration, pricing packages, team profiles, and e-commerce.',
    tags: ['Fitness', 'E-Commerce', 'Booking', 'Canada']
  },
  {
    num: 'WP·02',
    title: 'Edarat Group',
    url: 'https://edaratgroup.com',
    domain: 'edaratgroup.com',
    desc: 'Enterprise cloud & data center consultancy for the MENA/GCC region. Full WordPress/Elementor build with custom HTML video widgets, 8 service pages, investor relations section.',
    tags: ['Enterprise', 'Cloud', 'MENA', 'Elementor']
  },
  {
    num: 'WP·03',
    title: 'ManyGiggles',
    ...
    desc: 'AI-powered daycare & childcare management SaaS platform for Canada. WordPress marketing site featuring smart attendance, voice-to-text journaling, parent chat, digital enrollment.',
  ...
  },
  {
    ...
    desc: 'UAE business setup and professional services consultancy. WordPress site covering 7 service areas — company formation, taxation, accounting, compliance, audit, concierge, and IT services.',
...
export const reactProjects = [
  {
    num: 'RX·01',
    title: 'ViCA Global',
    url: 'https://crypto-wallet-web.vercel.app',
    domain: 'crypto-wallet-web.vercel.app',
    desc: 'Full-featured crypto exchange and wallet platform built with Next.js, Tailwind CSS, and Shadcn UI. Supports BTC, ETH, USDT, and VICA tokens with live P2P trading and secure escrow.',
    tags: ['Crypto / FinTech', 'Next.js', 'Shadcn UI'],
    badge: 'Next.js'
  },
  {
    num: 'RX·02',
    ...
    domain: 'app.cohrus.com',
    desc: 'Enterprise talent and HR web application built with React, Tailwind CSS, and Shadcn UI. Dual deployments: main Cohrus platform and Al Ghurair\'s dedicated instance.',
    tags: ['HR / Talent', 'React', 'Enterprise'],
    badge: 'React'
  },
  {
    num: 'RX·03',
    title: 'Parccom',
    domain: 'Parccom Platform',
    desc: 'Enterprise web application built with React, Tailwind CSS, and Shadcn UI as part of the Design Plex client portfolio. Complex data-driven UI with component-rich dashboard architecture.',
...
export const governmentProjects = [
  {
    num: 'GOV·01',
    title: 'SEDD — Sharjah Economic Development Dept',
    url: 'https://sedd.ae/en/web/sedd/home',
    domain: 'sedd.ae',
    desc: 'Government digital portal for the Sharjah Economic Development Department, UAE. Redesigned the full web portal and Android app UX, improving accessibility across 230+ government services. Built on Liferay DXP with bilingual EN/AR support. 4-year tenure (2019–2023).',
    tags: ['Government', 'UAE / Sharjah', 'Liferay DXP', 'Bilingual RTL', '230+ Services'],
    badge: 'Liferay DXP'
  },
  {
    num: 'GOV·02',
    title: 'MOHRE Kiosk — Ministry of HR & Emiratisation',
    domain: 'UAE Dubai Government · Dubai',
